...
export async function playBakeoffLive(spec,io){
  ...
  if(watch){
    ...
    { const g=$("bkoGo"); if(g)g.style.visibility="hidden"; }
  ...
  const goBtn=$("bkoGo");
  if(goBtn){goBtn.textContent=sayText("bake.go",{});goBtn.disabled=true;goBtn.style.visibility="";}   // back from the shuffle, as "Bake it!"
