...
He is expert at  describing intent; he needs accurate execution of it. Ask
before writing code, not after a review round. Never ask what the codebase or a measurement can
answer — go find out first, then ask only what is genuinely his call. Mark a
...
**Plain English, for a non-engineer.** Use Nouns from
the game — dubloons, the Pass button, the sea line — not from the toolchain. The test: *could he
repeat your sentence to a non-coder someone who has played the game?*  Every proposal says three things:
...
**DO ALL the work, don't ask him to prioritize** Wyatt, 2026-09-06: *"don't ask me my preference for
order: just do the work. Every time."* Sequencing is yours. The ask-2-5-questions
...
- **Front-load every decision before he goes away.** A run that blocks twenty minutes after he leaves
...
**One engine, one display path.** Host/guest decides who *computes* the game and who *creates* the room. It
