...
| **10** | **"heads = 6🌕 treasure found"** | **`dockHeads:5`** (`3291`) — changed 2026-08-08 on Wyatt's ask (*"Can we lower treasure to 5?"*), with a 600-voyage table justifying it | **DOC WRONG** |
