...
- [ ] **Phase 19: Safari Check** — **GATE.** Prove an always-on wind layer is safe in real Safari, and learn the dot-count budget, before Phase 20 invests. Builds a throwaway-able prototype; ships nothing final (WIND-00)
  ...
  **Plans:** 6 plans in 5 waves
  ...
  - [ ] 19-01-PLAN.md — Prove the iPhone can reach the branch build, and write the run protocol Wyatt operates from (wave 1)
  - [ ] 19-02-PLAN.md — The Wave 0 mechanical guard: `scripts/wind_dot_contract_check.js`, wired into `npm test` (wave 1)
  - [ ] 19-03-PLAN.md — Tracer: one dot drifts on the live wind, with an on-screen switch, dial and readout, off by default (wave 2)
