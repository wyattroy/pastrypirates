...
- [x] **FIX-06**: The 12 solid-orange `button.primary` buttons are restyled to the outline + faded-fill pattern.
...
- [x] **FIX-09**: On narrow mobile the ingredient chips stay readable instead of collapsing into one vertical column.
- [x] **FIX-17**: The coloured circle beside captain names is removed everywhere it appears, and the row shifts left.
