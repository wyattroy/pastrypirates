...
**FAILED** — 0 of 0 voyage(s) sailed  ·  2026-09-03T19:32:59.431Z  ·  0 min  ·  gear **COSMETIC**  ·  sailed on **win32 (Wy-Blade)**
...
game_url_check — one spelling of where the game is served, and it must be the game
  ...
  FAIL  1 hardcoded local game URL(s) — use gameURL(port) from lib/chrome.mjs: scripts\qa\_t102_shot.mjs:10
