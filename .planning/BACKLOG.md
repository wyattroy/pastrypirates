...
| W4-7 | **Board right edge and captains card may run past the right edge of the phone viewport at 390px.** ⚠️ **OBSERVED, NOT MEASURED** — spotted by CEO Review 13 in a W4-3 verification screenshot, raised so it is not lost. Related to W4-4 (the captains box not matching the board's width) but a different symptom: overflow rather than a short row. Measure the rects at 390px before believing it. |
