...
| **The Glass** | One published status page, regenerated at every heartbeat/item-close: running-now, last-progress timestamp (page shows staleness itself), shipped-today in player terms, launch progress, blocked-on-Wyatt queue with recommendations. | Checking in and wondering |
