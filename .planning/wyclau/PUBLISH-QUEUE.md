...
- [x] `T-264` — the Cloudflare cutover checklist he ticks — his standing instruction: artifacts, never .md — `cloudflare-cutover.html` — published: https://claude.ai/code/artifact/4c14a0bf-c373-476e-9b87-2cfeddd5c811
