...
>
> **`.planning/V1.3-V1.4-PLAN.md` is the current, Wyatt-ordered plan** (2026-07-31): ten phases split
> into **two** milestones — **v1.3 The Game Comes Alive** (phases 1–5, everything players see and
> hear, touches no game rules) and **v1.4 The Grind** (phases 6–10, bugs, the single engine
> re-record, copy, art). `.planning/research/v1.3-intake/RECONCILIATION.md` shows how
...
**Lane E is the loosest of the five and could be split further** — the art work and FIX-11's
multiplayer narration fix share a lane only because neither collides with anything else, not because
they belong together. **FIX-12 and LOAD-04, however, are genuinely one task** and must not be split:
see the note below.
...
| **Narration Pacing & Copy Integrity** | NARR-07 (Phase 26 below), the shipped-vs-approved copy gate, the two-scheduler unification, the two never-eyeballed D-41 greyed states | All four are the narration system's remaining debt, and three of them touch the same timing code |
