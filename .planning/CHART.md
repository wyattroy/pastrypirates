...
- [ ] **GLASS REDESIGN — Wyatt's seven priorities, in his words (2026-08-31, given to a cloud session; he stopped it there because this is visual work that belongs on the machine that renders it).** The engine owns this: render it, screenshot it, look at the picture, iterate locally, then publish. It is generated by `scripts/wyclau/glass.mjs` -- everything stays DERIVED, nothing hand-typed.
